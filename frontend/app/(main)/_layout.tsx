...
export default function MainLayout() {
  ...
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: { position: 'absolute', bottom: 0, left: 0, right: 0, height: tabBarHeight, backgroundColor: 'rgba(15, 23, 42, 0.92)', borderTopWidth: 0.5, borderTopColor: 'rgba(148, 163, 184, 0.1)', paddingTop: 6, paddingBottom: insets.bottom + 6, elevation: 0 }, tabBarActiveTintColor: '#818CF8', tabBarInactiveTintColor: 'rgba(148, 163, 184, 0.6)', tabBarLabelStyle: { fontSize: 11, fontWeight: '500', marginTop: 2 }, tabBarIconStyle: { marginBottom: -2 } }}>
      ...
      <Tabs.Screen name="family" options={{ title: 'Family', tabBarIcon: ({ color, focused }) => (<View style={focused ? styles.activeIconContainer : undefined}><Ionicons name={focused ? "people" : "people-outline"} size={22} color={color} /></View>) }} />
...
const styles = StyleSheet.create({
  activeIconContainer: { backgroundColor: 'rgba(129, 140, 248, 0.15)', borderRadius: 12, padding: 6, marginBottom: -6 },
  guardLoading: { flex: 1, backgroundColor: '#0F172A', justifyContent: 'center', alignItems: 'center' },
  guardText: { marginTop: 16, color: '#64748B', fontSize: 14 },
});
